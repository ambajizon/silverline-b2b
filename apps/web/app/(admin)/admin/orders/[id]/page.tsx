      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <ShippingDetails 
            ...
            shipAddress={order.reseller?.address}
            shipCity={null} // Not available in reseller data
            shipState={null} // Not available in reseller data
            shipPincode={null} // Not available in reseller data
            shipPhone={order.reseller?.phone}
          />
        </div>
      </div>
    </div>
